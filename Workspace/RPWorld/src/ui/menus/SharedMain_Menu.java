...
public class SharedMain_Menu extends Menu {
	...
	public void setup() {
		...
		buttons.add(new Button(new Rectangle(-200, 70, 200, 30), "Choose Map", "changestate_WORLD", 30));
		buttons.add(new Button(new Rectangle(-200, 30, 200, 30), "Exit to Menu", "changestate_MENU", 30));
	}
